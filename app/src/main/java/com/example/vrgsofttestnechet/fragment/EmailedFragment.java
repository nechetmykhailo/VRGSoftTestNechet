...
public class EmailedFragment extends Fragment {
    ...
    private RecyclerView rwEmailed;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_emailed, container, false);

        rwEmailed = v.findViewById(R.id.rwEmailed);
        models = new ArrayList<>();

        mLayoutManagers = new LinearLayoutManager(getContext());
        rwEmailed.setLayoutManager(mLayoutManagers);

        mAdapter = new RecyclerAdapterNews(getContext(), models, Constants.KEY_ALL);
        rwEmailed.setAdapter(mAdapter);
    ...
    private void metodGetRetrofitEmailed() {
        Call<JsonObject> call = api.getEmailed(Constants.API_KEYS);
